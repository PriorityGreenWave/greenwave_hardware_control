...
#define MQTT_SERIAL_PUBLISH_LTR "Area_1/catadioptrico_2/lastTagRead"
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str(),MQTT_USER,MQTT_PASSWORD)) {
      ...
      client.publish("Area_1/catadioptrico_2/lastTagRead", "00 00 00 00");
      // ... and resubscribe
